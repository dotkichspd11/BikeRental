...
if(isset($_GET["MaXe"]) && !empty(trim($_GET["MaXe"]))){
    // Include config file
    require_once "config.php";
    
    // Prepare a select statement
    $sql = "SELECT chitietxe.MaXe,chitietxe.TenXe,chitietxe.BienSoXe,chitietxe.KhungXe,chitietxe.MauSac,chitietxe.NamDangKy,chitietxe.TrangThai,chitietxe.HinhAnh,chitietxe.GiaThueTheoGio,chitietxe.GiaThueTheoNgay,chitietxe.GiaThueTheoThang,loaixe.TenLoaiXe FROM (chitietxe inner join loaixe on chitietxe.MaLoaiXe = loaixe.MaLoaiXe) where chitietxe.MaXe = ?";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Thông tin chi tiết về xe</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body card-body_config">
                                    <div class="card-image-product">
                                        <?php 
                                        echo "<img src='./img/$HinhAnh' style='width:400px; height:400px; border-radius:5px;'>"
                                        ?>
                                    </div>
                                    <div class="card-info-product">
                                        <h1><?php echo $row["TenXe"]; ?></h1>

                                        <div class="card-info-category">
                                            <div class="card-info-item">

                                                <span>Giá thuê giờ</span>
                                                <span
                                                    class="card-info-price"><?php echo $row["GiaThueTheoGio"]; ?>đ</span>
                                            </div>
                                            <div class="card-info-item">
                                                <span>Giá thuê ngày</span>
                                                <span
                                                    class="card-info-price"><?php echo $row["GiaThueTheoNgay"]; ?>đ</span>
                                            </div>
                                            <div class="card-info-item">
                                                <span>Giá thuê tháng</span>
                                                <span
                                                    class="card-info-price"><?php echo $row["GiaThueTheoThang"]; ?>đ</span>
                                            </div>
                                            <div class="card-info-item">
                                            ...
                                            <div class="card-info-item">
                                                <span style="line-height: 38px;margin-right: 14px;">Tình trạng
                                                    xe</span>
                                                <button type="button"
